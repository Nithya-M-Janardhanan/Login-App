...
class S {
  ...
  String get nameMustContain {
    return Intl.message(
      'Name must be more than 3 character',
      name: 'nameMustContain',
      desc: '',
      args: [],
    );
  }
  ...
  String get pwdMustNotLessthan {
    return Intl.message(
      'Password must not be less than 8',
      name: 'pwdMustNotLessthan',
      desc: '',
      args: [],
    );
  }
